...
var HELP_MESSAGE = "I am able to search for objects approaching the earth over the next week. Would you like me to search now? ";
var HELP_REPROMPT = "What can I help you with?";
var STOP_MESSAGE = "Goodbye! I hope that there will be no impacts and we will be able to speak again.";
...
exports.handler = function(event, context, callback) {
    ...
    console.log("event = %s", Util.inspect(event, true, null));
    console.log("context = %s", Util.inspect(context, true, null));
    console.log("callback = %s", Util.inspect(callback, true, null));
                ...
                if (data === null) {
                    ...
                    Object.keys(data.near_earth_objects).forEach(function(date) {
                        ...
                        for (let obj of data.near_earth_objects[date]) {
                            ...
                            if (parseInt(obj.close_approach_data[0].miss_distance.miles) < 1000) {
                            ...
                            } else if (parseInt(obj.close_approach_data[0].miss_distance.miles) < 100000) {
                    ...
                    // put it all together
                    output = ''
                    if (hit1m.length > 0 || hit7m.length > 0) {
                        ...
                        output = "There are no approaching asteroids coming within one hundred thousand miles this week.";
                    }
                }
